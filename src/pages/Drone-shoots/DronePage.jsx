    ...
    <div className="min-h-screen text-black">
      ...
      >
        ...
        <div className="container mx-auto px-4 text-white text-center relative z-10">
          <h2 className="text-2xl font-bold">Book Your Drone Shoot in Skardu Today!</h2>
          <p className="md:w-[70%] mx-auto container my-6">Whether you're a tourist, influencer, filmmaker, or real estate agent — our Skardu-based drone team is ready to bring your vision to life. Contact us now for pricing and availability.</p>
          <button
            onClick={openForm}
