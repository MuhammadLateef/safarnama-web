...
function HomePage() {
  return (
    <main className="w-full max-w-[90%] mx-auto  pb-20">
      <div className="container mx-auto px-4 py-12 text-center mb-12">
        ...
        <p className="text-gray-500">list of travel packages to cater your travel desire</p>
      </div>
